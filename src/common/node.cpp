...
Node::Node() : Node(nullptr, Unknown_Node)
{
}
Node::Node(std::shared_ptr<Node> const &parent, Node_Type type) : parent(parent), type(type)
{
}
...
Node_Type Node::get_type_() const
{
	return type;
}

void Node::set_type_(Node_Type type)
{
	this->type = type;
}
...
Value_Type TypeNode::getVariableType() const
{
	return variable_type;
}

void TypeNode::setVariableType(Value_Type variableType)
{
...
const std::string &VarTypeNode::get_name_() const
{
	return name;
}

void VarTypeNode::set_name_(const std::string &name)
{
	this->name = name;
}
...
DefNode::DefNode(std::shared_ptr<Node> const &parent, Node_Type type, char const *const name) : Node(parent, type), name(name)
{
}

const std::string &DefNode::get_name_() const
{
	return name;
}

void DefNode::set_name_(const std::string &name)
{
	this->name = name;
}
...
VarDefNode::VarDefNode(std::shared_ptr<Node> const &parent, Node_Type type, char const *const name, std::shared_ptr<TypeNode> const &variable_type, bool is_const) : DefNode(parent, type, name), variable_type(variable_type), is_const(is_const), var_type(), var_init_value(), block_id(-1), is_global(false), var_offset()
{
}
...
RefNode::RefNode(std::shared_ptr<Node> const &parent, Node_Type type, char const *const name) : Node(parent, type), name(name)
{
}

const std::string &RefNode::get_name_() const
{
	return name;
}

void RefNode::set_name_(const std::string &name)
{
	this->name = name;
}
...
VarNode::VarNode(std::shared_ptr<Node> const &parent, Node_Type type, char const *const name) : RefNode(parent, type, name), target_var(nullptr)
{
}
...
StmtNode::StmtNode(std::shared_ptr<Node> const &parent, Node_Type type, std::shared_ptr<Node> const &stmt) : Node(parent, type), stmt(stmt)
{
}
...
ParenthesisNode::ParenthesisNode(std::shared_ptr<Node> const &parent, Node_Type type, std::shared_ptr<Node> const &node) : Node(parent, type), node(node)
{
}
...
LiteralNode::LiteralNode(std::shared_ptr<LiteralNode> const &literal_node) : Node(literal_node->getParent(), literal_node->get_type_()), value(literal_node->getValue())
{
}

LiteralNode::LiteralNode(std::shared_ptr<Node> const &parent, Node_Type type, long long value) : Node(parent, type), value(value)
{
}
...
OperationNode::OperationNode() : operator_type(Unknown_Op), parameters()
{
}
...
IfElseNode::IfElseNode(std::shared_ptr<Node> const &parent, Node_Type type, std::shared_ptr<Node> const &condition, std::shared_ptr<BlockNode> const &if_body,
...
WhileNode::WhileNode(std::shared_ptr<Node> const &parent, Node_Type type, std::shared_ptr<Node> const &condition, std::shared_ptr<BlockNode> const &body) : Node(parent, type), condition(condition), body(body), continue_label_id(-1), break_label_id(-1)
{
}
...
ContinueNode::ContinueNode(std::shared_ptr<Node> const &parent, Node_Type type) : Node(parent, type)
{
}
...
BreakNode::BreakNode(std::shared_ptr<Node> const &parent, Node_Type type) : Node(parent, type)
{
}
...
ReturnNode::ReturnNode(std::shared_ptr<Node> const &parent, Node_Type type, std::shared_ptr<Node> const &return_value) : Node(parent, type), return_value(return_value), target(nullptr)
{
}
