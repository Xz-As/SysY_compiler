...
std::shared_ptr<Node> gen_child_node_(std::vector<std::shared_ptr<Token>>::const_iterator &current,
		std::vector<std::shared_ptr<Token>>::const_iterator &end, bool &is_reach_end);
std::shared_ptr<BlockNode> gen_node_(std::vector<std::shared_ptr<Token>>::const_iterator &current,
